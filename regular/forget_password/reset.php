...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-black">
    ...
    <div class="container ">
         <div class="mt-5 mx-auto">
          <label><h2>Recover Your Account</label></h2>
          
        </div>
        <form method="post" action="password_reset_email.php">
        <div>
           <label for="email" >Enter Your Register Email Id:</label>
            <input type="text" class="w-25 form-control mt-1" id="email" name="email_recover">
        </div>
        <div>
      ...
      <?php endif ?> 
         ...
         <div class="form-group w-25">
           <button type="submit" class="mt-4 btn btn-dark mb-5" name="submit">Submit</button>
        </div>
        </form>
  ...
  <footer class="page-footer font-small bg-dark pt-5 margin-top-1" >
