    ...
    <div class=" mx-auto w-25  ">
      <form>
        <div class="dropdown">
          ...
          <select name="meeting_type"  value="<?php echo $meeting_type; ?>">
              <option value="Regular">Regular</option>
              <option value="Festive">Festive</option>
              <option value="Observ">Observe</option>
            </select>
          </button>
        </div>
        <div class="form-group">
          <label for="meeting_code">Meeting Code:</label>
          <input type="text" class="form-control"  id="meeting_code" name="meeting_code" placeholder=""  value="<?php echo $meeting_code; ?>">
        </div>
        <div class="form-group">
          <label for="dress_code">Dress Code</label>
          <input type="text" class="form-control" id="dress_code" name="dress_code" value="<?php echo $dress_code; ?>" > 
        </div>
        <div class="form-group">
          <label for="meeting_desc">Metting Description</label>
          <input type="text" class="form-control" id="meeting_desc" name="meeting_desc"  placeholder="" value="<?php echo $meeting_desc; ?>">
        </div>
        <div class="form-group">
          <label for="speaker">Speaker</label>
          <input type="text" class="form-control" id="speaker" name="speaker"  placeholder="" value="<?php echo $speaker; ?>">
        </div>
        <div class="form-group">
          <label for="meeting_venue">Meeting Venue</label>
          <textarea class="form-control" name="meeting_venue" rows="5" id="meeting_venue" value="<?php echo $meeting_venue; ?>"></textarea>
        </div>
        <div class="form-group">
          <label for="speaker_details">Speaker Details</label>
          <textarea class="form-control" name="speaker_details" rows="5" id="speaker_details" value="<?php echo $speaker_details; ?>"></textarea>
        </div>
        <div class="form-group">
          <label for="meeting_date">Meeting Date & Time</label>
          <input type="datetime-local" class="form-control"  id="meeting_date" name="meeting_date"  placeholder="" value="<?php echo $meeting_date; ?>">
        </div>
        <div class="form-group">
          <label for="responce_date">Responce-Last Date</label>
          <input type="date" class="form-control" id="responce_date"  name="responce_date"  placeholder=""value="<?php echo $responce_date; ?>">
        </div>
        ...
        <div class="form-group row ">
          ...
          <div class="col-sm-4">
            <label for="food_veg">VEG:</label>
            <textarea class="form-control" rows="3" cols="10" name="food_veg" value="<?php echo $food_veg; ?>"></textarea>
          </div>
          <div class="col-sm-4">
            <label for="food_nonveg">NONVEG:</label>
            <textarea class="form-control" rows="3" cols="10" name="food_nonveg" value="<?php echo $food_nonveg; ?>"></textarea>
          </div>
          <div class="col-sm-4">
            <label for="food_fish">FISH:</label>
            <textarea class="form-control" rows="3" cols="10" name="food_fish" value="<?php echo $food_fish; ?>"></textarea>
          </div>
        </div>

        <div class="form-group">
          <label for="upload_files">Upload Files:</label>
          <input class="form-control" type="file" id="upload_files" name="upload_files"  placeholder=""value="<?php echo $upload_files; ?>">
        </div>
        <div class="form-group">
          <label for="other_info">Other Information:</label>
          <textarea class="form-control" rows="5" id="other_info" value="<?php echo $other_info; ?>"></textarea>
        </div>
        <div class="form-group">
